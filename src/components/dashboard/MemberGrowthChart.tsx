      ...
      <div className="border-b-2 border-border p-4 md:p-6 bg-background/30">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="text-base md:text-xl font-bold text-foreground">Medlem Vækst</h2>
          </div>
          <div className="w-8 h-8 md:w-10 md:h-10 rounded bg-primary/10 border border-primary/20 flex items-center justify-center group-hover:bg-primary/20 transition-colors flex-shrink-0">
            <Users className="h-4 w-4 md:h-5 md:w-5 text-primary" strokeWidth={2.5} />
          </div>
        </div>
      </div>
